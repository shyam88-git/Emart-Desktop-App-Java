...
public class DeleteItemFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDelete.setFont(new java.awt.Font("Yu Gothic Light", 1, 24)); // NOI18N
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String productId = tb.getValueAt(row, 0).toString();
        try{
            if(ProductDAO.deleteProduct(productId)){
                JOptionPane.showMessageDialog(null, "Product Deleted Sucessfully", "SUCESSFUL", JOptionPane.INFORMATION_MESSAGE);
                tb.setRowCount(0);
                loadProductsDetail();
                return;
            }
            JOptionPane.showMessageDialog(null, "Unable to delete record", "UNSUCESSFUL", JOptionPane.INFORMATION_MESSAGE);
